...
const leftbarMenuItemsWithKeys = leftbarMenuItems.map((section) => {
  return {
    uuid: uuidv4(),
    ...section,
...
const SectionMenuItems = ({ mainTitle, items, index }) => {
  const isTheLastSection = leftbarMenuItemsWithKeys.length - 1 === index;
  return (
    <>
      <div className="menu">
  ...
  return (
    <div className="leftbar">
      <div className="container">
        {leftbarMenuItemsWithKeys?.length > 0 &&
          leftbarMenuItemsWithKeys.map((section, index) => {
            return (
              <SectionMenuItems
                key={section.uid}
